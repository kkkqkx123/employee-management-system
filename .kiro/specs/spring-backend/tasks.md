...
- [ ] 2. Implement core security and permission system


- [ ] 2.1 Create permission management entities and repositories
...
- [ ] 2.2 Implement Spring Security configuration
...
- [ ] 2.3 Create permission verification service
...
- [ ] 3.1 Create department entity and repository
...
- [ ] 3.2 Implement department service layer
...
- [ ] 3.3 Create department REST controller
...
- [ ] 4. Implement position and title management
...
- [ ] 4.1 Create position entity and repository
...
- [ ] 4.2 Implement position service and controller
...
- [ ] 5.4 Implement E cel import/e port functionality
  ...
  - Create E celService for handling file import and e port operations
  - Implement employee data validation during E cel import
  - Add error reporting for invalid import data
  - Create E cel e port functionality with employee data formatting
  - Write tests for import/e port operations with sample files
...
- [ ] 5.5 Create employee REST controller
  ...
  - Add file upload endpoint for E cel import
  - Implement file download endpoint for E cel e port
...
- [ ] 9. Implement global e ception handling




- [ ] 9.1 Create custom e ception classes


  - Implement domain-specific e ception classes (EmployeeNotFoundE ception, etc.)
  - Create base e ception classes with proper error codes
  - Add validation e ception handling
  - Write tests for custom e ception behavior
  - _Requirements: 2.3, 2.5_

- [ ] 9.2 Implement global e ception handler


  - Create GlobalE ceptionHandler with @ControllerAdvice
  - Add handlers for all custom e ceptions and common Spring e ceptions
  - Implement proper error response formatting
  - Write tests for e ception handling scenarios
  - _Requirements: 2.3, 2.5_
